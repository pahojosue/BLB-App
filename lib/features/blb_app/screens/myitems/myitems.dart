  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        child: Column(
          children: [
           ...
           BLBPrimaryHeaderContainer(
            ...
            child: Column(
              children: [
                BLBAppBar(title: Text('My Items', style: Theme.of(context).textTheme.headlineMedium!.apply(color: BLBColors.white))),
            /// --SearchBar
      ...
      Padding(
        ...
        child: Column(
          children: [
            BLBSectionHeading(title: 'Borrowed Items', onPressed: () => Get.to(() => BorrowedItemsScreen())),
        ...
        Row(
          children: [
            for(int i = 0; i < 3; i++) const BLBCircularContainer(width: 20, height: 4, margin: EdgeInsets.only(right: 10), backgroundColor: Colors.green, image: ''),
...
Padding(
        ...
        child: Column(
          children: [
            ...
            BLBSectionHeading(title: 'Lent Items', onPressed: () => Get.to(() => LentItemsScreen())),
                  SizedBox(height: BLBSizes.spaceBtwItems),
...
Padding(
        ...
        child: Column(
          children: [
            ...
            BLBSectionHeading(title: 'Bartered Items', onPressed: () => Get.to(() => BarteredItemsScreen())),
                  SizedBox(height: BLBSizes.spaceBtwItems),
